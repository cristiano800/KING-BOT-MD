...
module.exports = {
    ...
    OWN_NUMBER: process.env.OWNER_NUMBER === undefined ? '212695290310' : process.env.OWN_NUMBER,
    OWN_NAME: process.env.OWNER_NAME === undefined ? 'ᴍᴏᴜᴀᴅ ᴇʟ' : process.env.OWN_NAME,
    BOT_NAME: process.env.BOT_NAME === undefined ? 'ᴏᴡᴇɴ ʙᴏᴛ' : process.env.BOT_NAME,
    ST_PKG: process.env.STICKER_PACKAGE === undefined ? 'ᴍʏ ɪɴsᴛᴀɢʀᴀᴍ :  ᴍᴏᴜᴜᴀᴅ__ᴇʟᴋ' : process.env.ST_PKG,
